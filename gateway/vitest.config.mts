...
export default mergeConfig(
  ...
  defineConfig({
    ...
    test: {
      ...
      alias: {
        '@blog': fileURLToPath(new URL('./src/test/javascript/spec/app/microfrontends/', import.meta.url)),
        '@store': fileURLToPath(new URL('./src/test/javascript/spec/app/microfrontends/', import.meta.url)),
      },

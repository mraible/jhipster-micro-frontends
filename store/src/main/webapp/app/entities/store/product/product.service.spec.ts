...
describe('Service Tests', () => {
  describe('Product Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Product('ABC', 'AAAAAAA', 0, 'image/png', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Product', async () => {
        const returnedFromService = { title: 'BBBBBB', price: 1, image: 'BBBBBB', ...elemDefault };

...
import { Post } from '@/shared/model/blog/post.model';
...
describe('Service Tests', () => {
  describe('Post Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Post('ABC', 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Post', async () => {
        const returnedFromService = { id: 'ABC', date: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
